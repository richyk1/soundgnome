---
name: "Soundgnome maintainer"
description: "Use when: handling a broad Soundgnome implementation task, cross-crate change, architecture-sensitive refactor, or repository-level bug fix where no narrower skill is sufficient. Read docs and code, make minimal changes, and preserve domain and repository architecture."
